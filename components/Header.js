  ...
  return (
    <div className='flex items-center fixed top-0 z-10 bg-red-500 w-full h-20'>
        <div className='flex justify-evenly bg-slate-200 w-full'>
            ...
            <Link href="#dgEquipment"><a>Equipment</a></Link>
            <Link href="#pmChampion"><a>Plague Marine Champion</a></Link>
            <Link href="#pmFighter"><a>Plague Marine Fighter</a></Link>
            <Link href="#pmIconBearer"><a>Plague Marine Icon Bearer</a></Link>
